...
int argumentInt(const String &message, int index, int default_value = 0) {
...
bool argumentBool(const String &message, int index, bool default_value = false) {
  String value = token(message, index);
  if (value == String())
    return default_value;
...
int argumentFloat(const String &message, int index, float default_value = 0.0f) {
  String value = token(message, index);
  if (value == String())
    return default_value;
